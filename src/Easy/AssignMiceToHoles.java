...
public class AssignMiceToHoles {
    ...
    public static void main(String[] args){
        ...
        ArrayList<Integer> mice = new ArrayList<>(Arrays.asList(-10, -79, -79, 67, 93, -85, -28, -94 ));
        ArrayList<Integer> holes = new ArrayList<>(Arrays.asList(-2, 9, 69, 25, -31, 23, 50, 78));
        int result= assignMiceToHoles.mice(mice,holes);
